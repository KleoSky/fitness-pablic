// source/scripts/modules/price.js
var buttons = document.querySelectorAll(".price__button");
var infoItems = document.querySelectorAll(".price__info-item");
var tabItems = document.querySelectorAll(".price__tab-item");
var switchTab = (rel) => {
...
// source/scripts/modules/hero.js
...
// source/scripts/modules/juri.js
var initSwiper = () => {
  document.addEventListener("DOMContentLoaded", () => {
...
// source/scripts/modules/faq.js
var buttons2 = document.querySelectorAll(".faq__tab-button");
var infoLists = document.querySelectorAll(".faq__info-list");
var tabItems2 = document.querySelectorAll(".faq__tab-item");
var switchFaqTab = (rel) => {
  buttons2.forEach((button) => {
    const isCurrent = button.getAttribute("rel") === rel;
    button.classList.toggle("faq__tab-button--current", isCurrent);
  });
  tabItems2.forEach((item) => {
...
var initAccordions = () => {
  ...
  const setDefaultState = () => {
    ...
    if (defaultItem) {
      ...
      state.set("tab4", /* @__PURE__ */ new Set(["tab8"]));
      saveState();
    }
  };
  setDefaultState();
    ...
    try {
      ...
      if (saved) {
        ...
        if (Array.isArray(parsed)) {
          const loadedState = /* @__PURE__ */ new Map();
  ...
  function handleAccordionClick(item) {
    ...
    const itemId = item.getAttribute("rel");
    if (!state.has(tabId)) {
      state.set(tabId, /* @__PURE__ */ new Set());
    }
...
// source/scripts/modules/form-validate.js
var FIELDS = {
  "name-input": {
...
var playerButton = document.querySelector(".about__play-button");
var iframeContainer = document.querySelector(".about__iframe-container");
var previewPicture = document.querySelector(".about__video");
var videoSrc = "http://www.youtube.com/embed/9TZXsZItgdw?si=-0rn2RyAriNlx1fp?autoplay=1";
var initVideo = () => {
  const renderIframe = () => {
...
// source/scripts/modules/reviews.js
var initSwiperReviews = () => {
  document.addEventListener("DOMContentLoaded", () => {
